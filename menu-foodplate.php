    ...
    <div class="container container-bottom">
        <div class="row">
            <div class="col-10">
                ...
                <small><i>Menu/Obat Kucing</i></small>
            </div>   
            <div class="col-2">
    ...
    <div class="container">
      <div class="wrapper-table">
        ...
        <tbody>
            ...
            <tr>
                <td>TB0030</td>
                <td>Hima Vet Obat Cacing 10ml</td>
                <td>14</td>
                <td>0</td>
                <td>
                  <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalDaftarAkun">
